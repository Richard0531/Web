...
def image(request): 
    ...
    def export_to_pdf(n_clicks,data):
        ...
        # 
        #table1 = Tabular('|p{0.45\linewidth}|p{0.45\linewidth}|')
        table1 = Tabular('|l c|l r|')
        table1.add_hline()
        ...
        table1.add_row((MultiColumn(2,align='|l|',data= 'St. Jude Children’s Research Hospital'),'','Page 1 of 1'))
        table1.add_row((MultiColumn(2,align='|l|',data= 'Clinical Pharmacotyping Laboratory'),'Form Number:  CPT.X.X',''))
        table1.add_row((MultiColumn(2,align='|l|',data= 'Memphis, TN  38105'),'',''))
        table1.add_hline()
        table1.add_row((MultiColumn(4, align='|c|', data='Quality Control – Plate Processing Analysis'),))
        table1.add_hline()
