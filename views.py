...
def image(request):
    ...
    app.layout = html.Div([
        ...
        dcc.Graph(id='output-image-upload', clear_on_unhover=True,config={"displaylogo": False,'modeBarButtonsToAdd':['drawopenpath','drawrect', 'eraseshape','resetViews','resetGeo'],
                                                                           'doubleClick': 'reset' }),
